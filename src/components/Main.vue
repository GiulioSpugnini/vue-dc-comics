<template>
  <div>
    <div id="content">
      ...
      <section>
        <ul id="cards">
          <li class="card-game" v-for="(game,index) in games" :key="index"  > <img :src="game.thumb" alt="">
          <p>{{game.series.toUpperCase()}}</p></li>
        </ul>
...
export default {
  ...
  data() {
    return {
      cards: [
        {
          imgUrl: require("../assets/buy-comics-digital-comics.png"),
          text: "DIGITAL COMICS",
        },
        {
          imgUrl: require("../assets/buy-comics-merchandise.png"),
          text: "DC MERCHANDISE",
        },
        {
          imgUrl: require("../assets/buy-comics-shop-locator.png"),
          text: "SUBSCRIPTION",
        },
        {
          imgUrl: require("../assets/buy-comics-subscriptions.png"),
          text: "COMIC SHOP LOCATOR",
        },
        {
          imgUrl: require("../assets/buy-dc-power-visa.svg"),
          text: "DC POWER VISA",
        },
      ],
      games: [ 
